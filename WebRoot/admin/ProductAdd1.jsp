...
<%
	...
	{	
		...
		out.println("<h2 style='color:#03a9f4;text-align:center;padding:6%;'>"+"添加新课程成功！~"+"</h2>");
		out.println("</div></div>");
		...
		<div style="padding:8% 5% 5% 5%;">
			<div class="boxs10 borr10 padpc5 widpc90">	
				...
				<div class="pad20 overfh" style="margin-left:100px; ">	
					...
					<form method="post" action="ProductAdd1.jsp" name="form1">
					...
					<table style="margin-top:20px;padding-left:10px;padding-right:10px;margin-bottom:3%;">						
						...
						<tr style="">
							...
							<td class="textl">
								<select name="categoryId" class="textc" style="width:155px;">
